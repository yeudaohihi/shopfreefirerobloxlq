              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    ...
                    <a href="{{ route('admin.accounts.groups', ['id' => $item->id]) }}" class="shadow btn btn-info btn-xs sharp me-1"><i class="fa fa-eye"></i> xem</a>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="{{ route('admin.accounts.categories.update', ['id' => $item->id]) }}" method="POST">
                        @csrf
                        <div class="mb-3">
