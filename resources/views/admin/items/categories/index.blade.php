              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    ...
                    <a href="{{ route('admin.items.groups', ['id' => $item->id]) }}" class="shadow btn btn-info btn-xs sharp me-1"><i class="fa fa-eye"></i> xem</a>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="{{ route('admin.items.categories.update', ['id' => $item->id]) }}" method="POST">
                        @csrf
                        <div class="mb-3">
  ...
  <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('admin.items.categories.store') }}" method="POST">
            @csrf
            <div class="mb-3">
              <label for="priority" class="form-label">Ưu tiên</label>
