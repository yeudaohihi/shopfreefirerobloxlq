...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="/_admin-v2/assets/images/brand-logos/favicon.ico" type="image/x-icon">
  ...
  <!-- Choices JS -->
  <script src="/_admin-v2/assets/libs/choices.js/public/assets/scripts/choices.min.js"></script>

  <!-- Main Theme Js -->
  <script src="/_admin-v2/assets/js/main.js"></script>

  <!-- Bootstrap Css -->
  <link id="style" href="/_admin-v2/assets/libs/bootstrap/css/bootstrap.min.css" rel="stylesheet">

  <!-- Style Css -->
  <link href="/_admin-v2/assets/css/styles.min.css" rel="stylesheet">

  <!-- Icons Css -->
  <link href="/_admin-v2/assets/css/icons.css" rel="stylesheet">

  <!-- Node Waves Css -->
  <link href="/_admin-v2/assets/libs/node-waves/waves.min.css" rel="stylesheet">

  <!-- Simplebar Css -->
  <link href="/_admin-v2/assets/libs/simplebar/simplebar.min.css" rel="stylesheet">

  <!-- Color Picker Css -->
  <link rel="stylesheet" href="/_admin-v2/assets/libs/flatpickr/flatpickr.min.css">
  <link rel="stylesheet" href="/_admin-v2/assets/libs/@simonwep/pickr/themes/nano.min.css">

  <!-- Choices Css -->
  <link rel="stylesheet" href="/_admin-v2/assets/libs/choices.js/public/assets/styles/choices.min.css">
...
<body>
  ...
  <!-- Loader -->
  <div id="loader">
    <img src="/_admin-v2/assets/images/media/loader.svg" alt="">
  </div>
  <!-- Loader -->
          ...
          <div class="header-element">
            <div class="horizontal-logo">
              <a href="index.html" class="header-logo">
                <img src="/_admin-v2/assets/images/brand-logos/desktop-logo.png" alt="logo" class="desktop-logo">
                <img src="/_admin-v2/assets/images/brand-logos/toggle-logo.png" alt="logo" class="toggle-logo">
                <img src="/_admin-v2/assets/images/brand-logos/desktop-dark.png" alt="logo" class="desktop-dark">
                <img src="/_admin-v2/assets/images/brand-logos/toggle-dark.png" alt="logo" class="toggle-dark">
                <img src="/_admin-v2/assets/images/brand-logos/desktop-white.png" alt="logo" class="desktop-white">
                <img src="/_admin-v2/assets/images/brand-logos/toggle-white.png" alt="logo" class="toggle-white">
              </a>
            </div>
          </div>
          <!-- End::header-element -->
        ...
        <div class="header-content-right">
          ...
          <div class="header-element country-selector">
            ...
            <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
              <img src="/_admin-v2/assets/images/flags/us_flag.jpg" alt="img" class="rounded-circle header-link-icon">
            </a>
            ...
            <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
              <li>
                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                  <span class="avatar avatar-xs lh-1 me-2">
                    <img src="/_admin-v2/assets/images/flags/us_flag.jpg" alt="img">
                  </span>
                  English
                </a>
              </li>
              <li>
                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                  <span class="avatar avatar-xs lh-1 me-2">
                    <img src="/_admin-v2/assets/images/flags/spain_flag.jpg" alt="img">
                  </span>
                  Spanish
                </a>
              </li>
              <li>
                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                  <span class="avatar avatar-xs lh-1 me-2">
                    <img src="/_admin-v2/assets/images/flags/french_flag.jpg" alt="img">
                  </span>
                  French
                </a>
              </li>
              <li>
                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                  <span class="avatar avatar-xs lh-1 me-2">
                    <img src="/_admin-v2/assets/images/flags/germany_flag.jpg" alt="img">
                  </span>
                  German
                </a>
              </li>
              <li>
                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                  <span class="avatar avatar-xs lh-1 me-2">
                    <img src="/_admin-v2/assets/images/flags/italy_flag.jpg" alt="img">
                  </span>
                  Italian
                </a>
              </li>
              <li>
                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                  <span class="avatar avatar-xs lh-1 me-2">
                    <img src="/_admin-v2/assets/images/flags/russia_flag.jpg" alt="img">
                  </span>
                  Russian
                </a>
              </li>
              ...
              <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                <li class="dropdown-item">
                  <div class="d-flex align-items-start cart-dropdown-item">
                    <img src="/_admin-v2/assets/images/ecommerce/jpg/1.jpg" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                ...
                <li class="dropdown-item">
                  <div class="d-flex align-items-start cart-dropdown-item">
                    <img src="/_admin-v2/assets/images/ecommerce/jpg/3.jpg" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                    <div class="flex-grow-1">
                      <div class="d-flex align-items-start justify-content-between mb-0">
                        <div class="mb-0 fs-13 text-dark fw-semibold">
                ...
                <li class="dropdown-item">
                  <div class="d-flex align-items-start cart-dropdown-item">
                    <img src="/_admin-v2/assets/images/ecommerce/jpg/5.jpg" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                    <div class="flex-grow-1">
                      <div class="d-flex align-items-start justify-content-between mb-0">
                        <div class="mb-0 fs-13 text-dark fw-semibold">
                ...
                <li class="dropdown-item">
                  <div class="d-flex align-items-start cart-dropdown-item">
                    <img src="/_admin-v2/assets/images/ecommerce/jpg/4.jpg" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                    <div class="flex-grow-1">
                      <div class="d-flex align-items-start justify-content-between mb-0">
                        <div class="mb-0 fs-13 text-dark fw-semibold">
                ...
                <li class="dropdown-item">
                  <div class="d-flex align-items-start cart-dropdown-item">
                    <img src="/_admin-v2/assets/images/ecommerce/jpg/6.jpg" alt="img" class="avatar avatar-sm avatar-rounded br-5 me-3">
                    <div class="flex-grow-1">
                      <div class="d-flex align-items-start justify-content-between mb-0">
                        <div class="mb-0 fs-13 text-dark fw-semibold">
                ...
                <div class="row g-2">
                    ...
                    <a href="javascript:void(0);">
                      <div class="text-center p-3 related-app">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img src="/_admin-v2/assets/images/apps/figma.png" alt="">
                        </span>
                  ...
                  <div class="col-4">
                    <a href="javascript:void(0);">
                      <div class="text-center p-3 related-app">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img src="/_admin-v2/assets/images/apps/microsoft-powerpoint.png" alt="">
                        </span>
                  ...
                  <div class="col-4">
                    <a href="javascript:void(0);">
                      <div class="text-center p-3 related-app">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img src="/_admin-v2/assets/images/apps/microsoft-word.png" alt="">
                        </span>
                  ...
                  <div class="col-4">
                    <a href="javascript:void(0);">
                      <div class="text-center p-3 related-app">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img src="/_admin-v2/assets/images/apps/calender.png" alt="">
                        </span>
                  ...
                  <div class="col-4">
                    <a href="javascript:void(0);">
                      <div class="text-center p-3 related-app">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img src="/_admin-v2/assets/images/apps/sketch.png" alt="">
                        </span>
                  ...
                  <div class="col-4">
                    <a href="javascript:void(0);">
                      <div class="text-center p-3 related-app">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img src="/_admin-v2/assets/images/apps/google-docs.png" alt="">
                        </span>
                  ...
                  <div class="col-4">
                    <a href="javascript:void(0);">
                      <div class="text-center p-3 related-app">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img src="/_admin-v2/assets/images/apps/google.png" alt="">
                        </span>
                  ...
                  <div class="col-4">
                    <a href="javascript:void(0);">
                      <div class="text-center p-3 related-app">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img src="/_admin-v2/assets/images/apps/translate.png" alt="">
                        </span>
                  ...
                  <div class="col-4">
                    <a href="javascript:void(0);">
                      <div class="text-center p-3 related-app">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img src="/_admin-v2/assets/images/apps/google-sheets.png" alt="">
                        </span>
            ...
            <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
              <div class="d-flex align-items-center">
                <div class="me-sm-2 me-0">
                  <img src="/_admin-v2/assets/images/faces/9.jpg" alt="img" width="32" height="32" class="rounded-circle">
                </div>
    ...
    <div class="main-content app-content">
      <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
          <h1 class="page-title fw-semibold fs-18 mb-0">@yield('title', 'Admin Panel V2')</h1>
  ...
  <!-- Popper JS -->
  <script src="/_admin-v2/assets/libs/@popperjs/core/umd/popper.min.js"></script>

  <!-- Bootstrap JS -->
  <script src="/_admin-v2/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Defaultmenu JS -->
  <script src="/_admin-v2/assets/js/defaultmenu.min.js"></script>

  <!-- Node Waves JS-->
  <script src="/_admin-v2/assets/libs/node-waves/waves.min.js"></script>

  <!-- Sticky JS -->
  <script src="/_admin-v2/assets/js/sticky.js"></script>

  <!-- Simplebar JS -->
  <script src="/_admin-v2/assets/libs/simplebar/simplebar.min.js"></script>
  <script src="/_admin-v2/assets/js/simplebar.js"></script>

  <!-- Color Picker JS -->
  <script src="/_admin-v2/assets/libs/@simonwep/pickr/pickr.es5.min.js"></script>

  <!-- Apex Charts JS -->
  <script src="/_admin-v2/assets/libs/apexcharts/apexcharts.min.js"></script>

  <!-- Custom-Switcher JS -->
  <script src="/_admin-v2/assets/js/custom-switcher.min.js"></script>
  ...
  <!-- Custom JS -->
  <script src="/_admin-v2/assets/js/custom.js"></script>
